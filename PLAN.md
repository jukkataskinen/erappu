...
- [x] Postita-tili ja tunnukset tuotantoon (`POSTITA_MODE=http`, 26.9.2026): ensimmäiset kirjeet ladattu tuotannosta – BLOCKERS 15
...
- [x] Vesimittarit ja vesilaskutus (Jukka 17.9.2026): huoneistojen kylmän ja lämpimän veden mittarit, lukukierrokset (lukemat henkilökunnalta tai osakkaalta/asukkaalta portaalissa), huoneistokohtainen vesiennakko kuukausilaskulle ja tasauslasku laskutusajona (`/taloyhtiot/[id]/talous/vesi`, 0100). Laskurivillä mittari, vanha ja uusi lukema päivineen, kulutus × €/m³; lämpimällä vedellä voi olla oma hinta; kauden ennakot miinusrivinä. Lukeman kuittaus, jos pienempi kuin edellinen tai kulutus alle 2 tai yli 500 m³. Pohjalukemat 12/2025 Toivakan Asunto Oy:lle ja Kotipesälle Procountorin vesilaskuilta.
  ...
  - [x] Lukemien CSV-tuonti kierrokselle (mittarinumero tai huoneisto + tyyppi), kuva mittarista portaalista (0110), tasauksen kulutus huoneistoittain kulutusseurantaan ja vertailu päämittariin (0109) (19.9.2026)
...
- [ ] **Asiakirjojen varmuuskopio OneDriveen (tehdään pian, Jukka 23.9.2026).** Supabasen varmuuskopio kattaa vain tietokannan, ei Storagen tiedostoja. Ajastettu ajo kokoaa jokaisen yhtiön aineistozipin, salaa sen (AES-256, avain Vercelin ympäristömuuttujissa) ja vie Microsoft Graphilla Adeptan OneDriveen. Yksi yhtiö kerrallaan, tulos lokiin. Vaatii sovellusrekisteröinnin Entra ID:hen. Palvelusopimuksen kohta 5.3 lupaa tämän.
...
- [x] Huoltopyyntöjen tori palveluntuottajille (Jukka 17.9.2026, toteutettu 17.9.2026): isännöitsijä vie pyynnön torille, hyväksytyt palveluntuottajat näkevät sen ja voivat varata työn itselleen. Luonteva ensimmäinen yhteinen näkymä palveluntuottajajärjestelmälle (edellinen kohta). Rajaukset:
  ...
  - Päätökset tehty 17.9.2026 (näkyvyys, taloyhtiön päätös, hinnat, varaus, tieto asukkaalle, tuntiarvio euro-rajaa vasten).
  - [x] Migraatio 0096: `er_marketplace_listings`, `er_marketplace_approvals`, palveluntuottajan tuntihinta, yhtiön torisäännöt (päätös, euro-raja, pöytäkirjaviite), linkkityyppi `provider_marketplace`, tapahtumatyyppi `marketplace`
  - [x] Palveluntuottajalla ei ole tunnuksia: henkilökohtainen torilinkki `/tori/[token]` (365 pv, uusi mitätöi vanhan), jaettavissa WhatsAppiin. Vapaat työt (ala, paikkakunta, kuvaus), varaus arvioidulla päivällä ja tuntiarviolla, omat varaukset ja "Avaa työtilaus"
  - [x] Henkilökunta: huoltopyynnön Tori-kohta (vienti kuvauksella, varauksen tila, hyväksy tai hylkää rajan ylittävä, poista torilta), palveluntuottajan Tori-kohta (tuntihinta, hyväksyntä organisaatiolle tai yhtiöille, torilinkki), yhtiön Huolto-välilehden torisäännöt, työpöydän nosto hyväksyntää odottavista
  - [x] Viikon voimassaolo: `maintainMarketplace` päivittäisessä muistutusajossa ja torisivun latauksessa (tehdyt valmiiksi, rauenneet torille, tehtävälinkki mitätöidään, ilmoitukset)
  - [x] Testit `tests/db/tori.test.ts` (näkyvyys, tietojen minimointi, lukitus, raja ja hyväksyntä, raukeaminen, torilinkki)
  - [ ] Tori siirtyy eKeikka.fi:hin ja palveluntuottaja saa omat tunnukset (edellinen kohta); torilinkki on siihen asti väliaikainen ratkaisu
...
- [x] Vuosikello Jukan mallikuvan pohjalta (17.9.2026): hallituksen kokoukset (talvi: KPTS, talousarvio ja viestintä; kevät: tilinpäätös ja yhtiökokouksen valmistelu; järjestäytymiskokous; kesä: hankkeet; syksy: kirjanpito), yhtiökokoustiedote, talveen varautuminen (kiinteistö- ja pihakierros) ja asukastiedotteet vuodenajoittain. Migraatio 0098 luokat `board_meeting` ja `communication`; talousarvio siirtyi talven hallituksen kokoukseen (hyväksytään kevään yhtiökokouksessa)
  - [x] Asukastiedote-tehtävästä suora linkki tiedoteluonnokseen valmiilla tekstillä (19.9.2026: pohjat kevät, kesä, syksy, talvi, yhtiökokoustiedote ja talveen varautuminen, `src/lib/announcements/drafts.ts`; hakasulkeissa olevat kohdat estävät julkaisun)
  - [x] Vuosikello ympyräkuvana (vuodenajat, hallitus ulkokehällä, asukasviestintä sisällä) yhtiön sivulle ja portaaliin (19.9.2026: yhtiön Vuosikello-välilehti tehtävistä, portaali `/portaali/vuosikello` vakiovuosikellosta; osakkaat näkevät yhtiökokouksen, tiedotteet ja talveen varautumisen, hallitus kaikki)
- [x] Varsinaisen yhtiökokouksen esityslista yhtiöjärjestyksen mukaan (Jukka 17.9.2026, malli As Oy Paikkalantorpat 2025): migraatio 0097 hallituksen ja tarkastajien määrät (kiinteä tai väli, toiminnantarkastaja / tilintarkastaja / ei pakollinen, lähde), `src/lib/meetings/agenda.ts`, muokkaus Hallitus-välilehdellä. Lain mukaan lisätty hallituksen selvitykset kunnossapitotarpeesta ja tehdyistä töistä (AOYL 6:3 §); lakiviitteet korjattu (äänileikkuri 6:13 §, kutsuaika 6:20 §, kutsutapa 6:21 §). Määrät kirjattu 11 yhtiölle yhtiöjärjestyksistä.
  ...
  - [x] Kiinteistöosakeyhtiön (Säästövakka) esityslista osakeyhtiölain mukaan (19.9.2026: migraatio 0107 `governing_act`, valinta Hallitus-välilehdellä; OYL 5:3 §:n asiat, ei kunnossapitoselvityksiä, ei äänileikkuria (OYL 5:12 §), kutsuaika viikko (OYL 5:19 §); AOYL 28:1 § mukaan koy on oletuksena AOYL:n alainen)
- [x] Yhtiökokouksen pöytäkirjaan osake- ja äänimäärätaulukko (Jukka 17.9.2026, tehty: kohtaan 3 toteamus edustetuista osakkeista ja äänistä määrinä ja prosentteina, äänileikkuri mainitaan; ääniluettelo pöytäkirjan liitteeksi; osallistujat esitäytetään automaattisesti): paikallaolijoiksi merkityt osakkaat ja valtakirjalla edustetut, heidän osakkeensa ja äänensä (äänileikkuri AOYL 6:24 huomioiden) ja yhteismäärät. Pohjana kokousmoduulin osallistujat ja ääniluettelo (M5).
- [x] Lainaosuuslaskelmat ja jälkilaskelmat tilinpäätökseen (Jukka 17.9.2026, toteutettu 19.9.2026: `/taloyhtiot/[id]/talous/tilinpaatos`, 0102; lainojen tilikauden luvut käsin kirjanpidosta ja pankin saldotiedoista, osuudet osakkeiden suhteessa, jälkilaskelma ja AOYL 10:5 §:n 1 kohdan teksti toimintakertomukseen, PDF hallitukselle; kirjanpidon tuonti Procountorista/PPR:stä myöhemmin): osakeryhmittäiset lainaosuudet tilikauden alussa ja lopussa, kertasuoritukset, rahoitusvastikkeet ja niiden kohdistus lainoille, jälkilaskelma (rahoitusvastikkeiden käyttö ja tase-erät) tilinpäätöksen liitteeksi. Pohjana M3 lainat ja lainaosuudet; kirjanpidon tiedot Procountorista (2027 loppuun) ja myöhemmin PPR:stä.
- [x] Osakkaan lainaosuuslaskelma (Jukka 19.9.2026): huoneiston talous -sivulta PDF lainaosuuksista, kertasuorituksen arvio maksupäivälle (tasalyhennys), valinnainen käsittelymaksu ja maksuohje; tallennus huoneiston dokumentteihin, näkyvyys osakkaalle valittavissa.
