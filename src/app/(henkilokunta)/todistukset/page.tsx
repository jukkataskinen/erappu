...
export default async function CertificatesPage({ searchParams }: { searchParams: Promise<{ virhe?: string }> }) {
  ...
  const [orders, companies, groups] = await ctx.run((tx) =>
    Promise.all([
      listOrders(tx, orgId, { limit: 300 }),
  ...
  return (
    <>
      <PageHeader title="Isännöitsijäntodistukset" subtitle="Tilaukset ja todistukset kaikista taloyhtiöistä" back={{ href: "/kokoukset", label: "Kokoukset" }} />
      ...
      <div className="grid gap-6 xl:grid-cols-[1.7fr_1fr]">
        ...
        <div className="grid content-start gap-6">
          ...
          <Panel>
            <SectionTitle>Tilauslinkit</SectionTitle>
