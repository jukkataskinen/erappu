/**
 * eSinetti-liitännän tyypit. Kopioitu Reilusopparista (CLAUDE.md 1,
 * "Allekirjoitukset") ja mukautettu eRapulle.
 *
 * eRappu ei toteuta tunnistusta, allekirjoitusta eikä sinetöintiä itse.
 * Nämä tyypit kuvaavat sen rajapinnan, jonka takana eSinetti on — ja vain sen.
 *
 * ===========================================================================
 * MITÄ TÄSSÄ EI OLE: RENDERÖINTI
 *
 * eRappu tekee allekirjoitettavan PDF:n itse (`src/documents/`), ja eSinetti
 ...
 * 0.1 kohta 2). `expectedBirthdate` on mukana, koska eSinetti käyttää sitä
 * tunnistuksen tarkistukseen; eRappu ei välitä sitä kokousten
 * allekirjoituksissa.
 * ===========================================================================
 */
...
export interface CreateRoundInput {
  ...
  /**
   * Oma tunniste, jolla kierros löytyy takaisin: `erappu:meeting:<uuid>`.
