...
export const DOCUMENT_CATEGORIES = [
  ...
  "contract", "condition_assessment", "maintenance_plan", "maintenance_needs_report", "manager_certificate", "rescue_plan", "renovation_guide", "photo", "insurance", "other",
] as const;
...
export const CATEGORY_LABEL: Record<DocumentCategory, string> = {
  ...
  renovation_guide: "Muutostyöohje",
  photo: "Kuva",
  insurance: "Vakuutus",
  other: "Muu",
};
