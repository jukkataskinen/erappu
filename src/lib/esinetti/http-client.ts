/**
 * eSinetin REST-API -client. Kopioitu Reilusopparista (CLAUDE.md 1).
 *
 * ===========================================================================
 * TIETOTURVAKATSELMUS (CLAUDE.md 0.1)
 *
 * 1. Kuka saa kutsua: vain palvelinkoodi. API-avain on isännöintiyrityksen
 *    tenantin pääsy kaikkiin sen asiakirjoihin, joten se ei saa päätyä
