...
const PRICING_FAQ = [
  ...
  },
  {
    ...
    answer: "Hinta on taloyhtiökohtainen ja lasku menee suoraan taloyhtiölle. Vuosimaksu laskutetaan etukäteen kerran vuodessa, ja se on noin kymmenyksen edullisempi kuin kuukausilaskutus.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        lead={`Perusmaksu taloyhtiöltä ja pieni maksu huoneistolta. Vuosimaksulla ${formatEuro(YEARLY_MONTHLY.base)} kuukaudessa taloyhtiöltä ja ${formatEuro(YEARLY_MONTHLY.perUnit)} huoneistolta, vähintään ${formatEuro(YEARLY_MONTHLY.minimum)} kuukaudessa. Kuukausilaskutuksessa ${formatEuro(MONTHLY.base)}, ${formatEuro(MONTHLY.perUnit)} ja vähintään ${formatEuro(MONTHLY.minimum)}.`}
      />
      ...
      <Section tone="cloud" title="Hinnasto">
        <div className="grid gap-6 md:grid-cols-2">
          {(
            [
              { title: "Vuosimaksu", note: "Edullisin hinta, laskutus kerran vuodessa", rates: YEARLY_MONTHLY, highlight: true },
